...
public class JwtTokenUtil {
    //私钥
    private static final String SECRET_KEY = "vhr-service";
    ...
    public String generateToken(Hr hr) {
        ...
        //把用户名和签发时间封装在claims中
        claims.put(Claims.SUBJECT, hr.getUsername());
     ...
     * @return 是否有效
     */
    public Boolean validateToken(String token, Hr hr) throws Exception {
        Hr user = (Hr) hr;
